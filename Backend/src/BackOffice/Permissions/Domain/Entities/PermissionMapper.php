...
class PermissionMapper
{
    ...
    {
        $this->config->registerMapping('array', PermissionDto::class)->withNamingConventions(
            ...
            return $source['uuid'];
        })->forMember('slug', function($source){
            return ($source['slug'])? $source['slug'] : '';
        })->forMember('icon', function($source){
