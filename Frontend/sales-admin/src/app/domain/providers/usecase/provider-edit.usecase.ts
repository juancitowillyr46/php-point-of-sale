...
export class ProviderEditUseCase implements UseCase<ProviderStoreDto, ResponseIdDataDto> {
    ...
    public execute(object: ProviderStoreDto): Observable<ResponseIdDataDto> {
        ...
        return that.providerRepository.edit(object.id, object).pipe(map(res => {
