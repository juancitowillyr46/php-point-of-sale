...
export class PurchaseDetailEditUseCase implements UseCase<PurchaseDetailStoreDto, ResponseIdDataDto> {
    ...
    public execute(object: PurchaseDetailStoreDto): Observable<ResponseIdDataDto> {
        ...
        return that.purchaseDetailRepository.edit(object.id, object).pipe(map(res => {
